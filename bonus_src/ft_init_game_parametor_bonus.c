...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_init_game_parametor_bonus.c                     :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ymatsuna <ymatsuna@student.42tokyo.jp>     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/26 12:32:24 by ymatsuna          #+#    #+#             */
/*   Updated: 2022/03/27 11:25:59 by ymatsuna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_set_enemy_pos_on_map(t_gmobj *gm)
{
	int	x;
	int	y;
	...
	while (*(gm->map + y) != NULL)
	{
		while (*(*(gm->map + y) + x) != '\0')
		{
			if (*(*(gm->map + y) + x) == SPACE)
			{
				gm->eny.x = x;
				gm->eny.y = y;
				*(*(gm->map + gm->eny.y) + gm->eny.x) = ENEMY;
				return ;
			}
			x++;
		}
